...
namespace App\Domain\Auth\Module\ValueObjects;
...
class Validation extends BaseValidation implements ValidationInterface
{
    ...
    public static function getRulesCreate(): array
    {
        return [
            ...
            'url'       => 'required|regex:/^['.self::ALPHA_LOWER_DASHES.']+$/',
    ...
    public static function getRulesUpdate(): array
    {
        return [
            ...
            'url'       => 'sometimes|required|regex:/^['.self::ALPHA_LOWER_DASHES.']+$/',
            'method_id' => 'sometimes|required|integer|exists:methods,id',
            'active'    => ['regex:/^['.self::ONE_OR_ZERO.']$/'],
        ];
    }
    ...
    public static function getMessages(): array
    {
        return [
            ...
            'url.regex'    => __('alpha_lower_dashes_validation'),
